...
const REGIMENES_FISCALES = ["601 - General de Ley Personas Morales", "603 - Personas Morales con Fines no Lucrativos", "605 - Sueldos y Salarios", "606 - Arrendamiento", "606 - Arrendamiento", "608 - Demás ingresos", "611 - Ingresos por Dividendos (socios y accionistas)","612 - Personas Físicas con Actividades Empresariales y Profesionales", "614 - Ingresos por intereses","616 - Sin obligaciones fiscales", "621 - Incorporación Fiscal", "625 - Régimen de las Actividades Empresariales con ingresos a través de Plataformas Tecnológicas","626 - Régimen Simplificado de Confianza"];
const USOS_CFDI = ["G01 - Adquisición de mercancías", "G03 - Gastos en general", "D01 - Honorarios médicos", "D02 - Gastos médicos por incapacidad", "D04 - Donativos", "D10 - Pagos por servicios educativos (colegiaturas)", "S01 - Sin efectos fiscales","CP01 - Pagos"];
